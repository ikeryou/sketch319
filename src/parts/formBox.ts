...
export class FormBox extends MyDisplay {
  ...
  protected _update(): void {
    ...
    Tween.instance.set(this._con, {
      x: sw * 0.5 + (mx * sw * 0.1 * Util.instance.map(dy, 2, 0.1, 0, 1) * 1),
